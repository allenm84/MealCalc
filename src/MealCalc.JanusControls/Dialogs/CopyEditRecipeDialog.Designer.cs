namespace MealCalc.JanusControls
{
  partial class EditRecipeDialog
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.numParts = new MealCalc.JanusControls.NumericEdit();
      ...
      this.gridIngredients.TabIndex = 2;
      this.gridIngredients.RowDoubleClick += new Janus.Windows.GridEX.RowActionEventHandler(this.gridIngredients_RowDoubleClick);
      this.gridIngredients.FormattingRow += new Janus.Windows.GridEX.RowLoadEventHandler(this.gridIngredients_FormattingRow);
    ...
    private MealCalc.JanusControls.NumericEdit numParts;
