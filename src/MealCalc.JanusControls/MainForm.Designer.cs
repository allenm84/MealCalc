namespace MealCalc.JanusControls
{
  partial class MainForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.gridRecipes = new Janus.Windows.GridEX.GridEX();
      ...
      this.gridRecipes.RowDoubleClick += new Janus.Windows.GridEX.RowActionEventHandler(this.gridRecipes_RowDoubleClick);
    ...
    private Janus.Windows.GridEX.GridEX gridRecipes;
  }
}
